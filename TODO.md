...
- [x] Schema-aware multi-condition equality filter builder with constrained controls, AND composition, URL persistence, bounded decoding, and progressive row management.
